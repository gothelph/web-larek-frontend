...
export class Order extends Form<IOrderInfo> {
  ...
  constructor(events: IEvents, container: HTMLFormElement) {
    ...
    this._paymentOnline = ensureElement<HTMLButtonElement>(settings.orderSettings.payment.online, this.container);
    this._paymentCash = ensureElement<HTMLButtonElement>(settings.orderSettings.payment.cash, this.container);
